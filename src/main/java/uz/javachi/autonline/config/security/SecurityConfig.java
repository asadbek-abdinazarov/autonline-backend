...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:3000,https://autonline-production.up.railway.app,https://autonline-admin-panel-production.up.railway.app,http://localhost:3001,http://localhost:8080}")
