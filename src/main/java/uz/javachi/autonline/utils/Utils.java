...
public class Utils {
    public static JwtResponse buildJwtResponse(String token, User user, Subscription subscription, List<String> subscriptionPermissions, List<String> rolePermissions, List<String> roles) {
